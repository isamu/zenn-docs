...
emoji: "🖥️"
type: "tech"
topics: ["ClaudeCode", "terminal", "vibecoding", "開発環境", "AI"]
published: true
...
> 📝 **その後の話**：ここで「さばく速度」が律速だと書きましたが、その後どうなったかというと、**僕はコードレビューそのものをやめました**。[1日500コミットは、もう読めない ── だからコードレビューをやめた](https://zenn.dev/singularity/articles/stopped-reviewing-my-code) に、読まずに済ませるために何を整えたか（規約・lint・テスト・CI・AI 同士のレビュー）を設定ファイルごと書いています。
