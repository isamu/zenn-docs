...
もともと、レビューの主役は **CodeRabbit** でした。指摘の質は本当に良いのですが、無料のまま使っていたので順番待ちがあって、**PR を出してからレビューが返ってくるまで1時間**かかる。

その1時間を、僕と中島さんの2人で、**黙って待っていました**。課金もせずに。今思うと笑えます。世界一高い人件費で、無料枠の順番待ちをしていたわけです。

さすがにこれは違うだろう、ということで、僕が Codex の API キーを設定して CI から回してみました。すると、**まあまあちゃんとレビューが返ってくる**。それで今の形になりました。

この体験で確信したのですが、**レビューが CI の中で回ることが、とにかく重要**です。

人間が「レビューして」と頼む工程が1つでも挟まると、そこで必ず止まります。**push したら勝手にレビューが始まって、戻ってきたら指摘が積まれている。** この形でないと、レビューは自動化の輪に入りません。逆に言えば、輪の中に入れさえすれば、レビューは「待つもの」ではなく「流れてくるもの」になります。
